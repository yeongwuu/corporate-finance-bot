...
ADVANCED_QUESTION_SEEDS = [
    "SK하이닉스의 WACC를 7~11%, 영구성장률을 1~4%로 변경해 적정 주가 민감도 표를 만들고 현재 주가 대비 고평가·저평가 여부를 분석해줘.",
    "삼성전자·SK하이닉스·삼성전기의 최근 5년 주가를 이용해 최대 샤프지수 포트폴리오와 최소분산 포트폴리오를 구성해줘.",
    "기준금리가 1%p 상승하고 원/달러 환율이 10% 하락하면 삼성전자의 영업이익과 적정가치는 어떻게 변할까?",
    "삼성전자와 SK하이닉스의 향후 수익률 분포를 몬테카를로 시뮬레이션으로 비교해줘.",
    "현대차의 WACC를 7~11%, 영구성장률을 1~4%로 변경해 적정 주가 민감도 표를 만들고 현재 주가 대비 고평가·저평가 여부를 분석해줘.",
    "LG에너지솔루션의 매출 성장률이 5%p, 영업이익률이 2%p 동시에 하락하는 스트레스 시나리오를 분석해줘.",
    "삼성전자·SK하이닉스·삼성전기의 최근 3년 주가로 위험 대비 수익률이 가장 높은 포트폴리오를 구성해줘.",
    "기준금리가 1%p 상승하고 원/달러 환율이 10% 오르면 삼성전기의 영업이익과 적정가치는 어떻게 변할까?",
    "현대차·기아·현대모비스의 최근 5년 주가를 이용해 최대 샤프지수 포트폴리오와 최소분산 포트폴리오를 구성해줘.",
    "현대차의 매출 성장률이 4%p, 영업이익률이 2%p 동시에 하락하는 스트레스 시나리오를 분석해줘.",
]
VALUATION_STRESS_QUESTION_SEEDS = [
    "SK하이닉스의 WACC를 7~11%, 영구성장률을 1~4%로 변경해 적정 주가 민감도 표를 만들고 현재 주가 대비 고평가·저평가 여부를 분석해줘.",
    "현대차의 WACC를 7~11%, 영구성장률을 1~4%로 변경해 적정 주가 민감도 표를 만들고 현재 주가 대비 고평가·저평가 여부를 분석해줘.",
    "삼성전자의 WACC를 6~10%, 영구성장률을 1~4%로 변경해 적정 주가 민감도를 계산하고 현재 주가 대비 고평가·저평가 여부를 분석해줘.",
    "LG에너지솔루션의 WACC를 7~11%, 영구성장률을 1~4%로 변경해 적정 주가 민감도 표를 만들고 현재 주가 대비 고평가·저평가 여부를 분석해줘.",
    "삼성전기의 WACC를 7~10%, 영구성장률을 1~3%로 변경해 적정 주가 민감도를 계산하고 현재 주가 대비 고평가·저평가 여부를 분석해줘.",
    "기아의 WACC를 7~11%, 영구성장률을 1~4%로 변경해 적정 주가 민감도 표를 만들고 현재 주가 대비 고평가·저평가 여부를 분석해줘.",
    "삼성전자의 WACC를 7~9%, 영구성장률을 1~3%로 변경해 적정 주가 민감도 표를 만들고 현재 주가 대비 고평가·저평가 여부를 분석해줘.",
    "SK하이닉스의 WACC를 8~10%, 영구성장률을 1~3%로 변경해 적정 주가 민감도 표를 만들고 현재 주가 대비 고평가·저평가 여부를 분석해줘.",
    "현대차의 WACC를 8~10%, 영구성장률을 1~3%로 변경해 적정 주가 민감도 표를 만들고 현재 주가 대비 고평가·저평가 여부를 분석해줘.",
    "기아의 WACC를 8~10%, 영구성장률을 1~3%로 변경해 적정 주가 민감도 표를 만들고 현재 주가 대비 고평가·저평가 여부를 분석해줘.",
    "LG에너지솔루션의 WACC를 8~10%, 영구성장률을 1~3%로 변경해 적정 주가 민감도 표를 만들고 현재 주가 대비 고평가·저평가 여부를 분석해줘.",
    "삼성전기의 WACC를 8~10%, 영구성장률을 1~3%로 변경해 적정 주가 민감도 표를 만들고 현재 주가 대비 고평가·저평가 여부를 분석해줘.",
    "기준금리가 1%p 상승하고 원/달러 환율이 10% 하락하면 SK하이닉스의 영업이익과 적정가치는 어떻게 변할까?",
    "기준금리가 1%p 상승하고 원/달러 환율이 10% 오르면 현대차의 영업이익과 적정가치는 어떻게 변할까?",
    "기준금리가 0.5%p 상승하고 원/달러 환율이 8% 하락하면 삼성전자의 영업이익과 적정가치는 어떻게 변할까?",
    "LG에너지솔루션의 매출 성장률이 5%p, 영업이익률이 2%p 하락하는 스트레스 시나리오를 분석해줘.",
    "SK하이닉스의 매출 성장률이 5%p, 영업이익률이 3%p 하락하는 스트레스 시나리오를 분석해줘.",
    "현대차의 매출 성장률이 4%p, 영업이익률이 2%p 하락하는 스트레스 시나리오를 분석해줘.",
    "삼성전자의 매출 성장률이 3%p, 영업이익률이 1%p 하락하는 스트레스 시나리오를 분석해줘.",
    "LG에너지솔루션의 매출이 5% 감소하고 매출원가율이 2%p 상승하는 시나리오를 분석해줘.",
    "현대차의 매출이 4% 감소하고 매출원가율이 2%p 상승하는 시나리오를 분석해줘.",
    "삼성전자의 매출이 3% 감소하고 매출원가율이 1%p 상승하는 시나리오를 분석해줘.",
    "주당 배당금 2,000원, 배당성장률이 3%에서 5%로 상승하고 요구수익률이 9%일 때 주식가치 변화를 계산해줘.",
    "주당 배당금 1,500원, 배당성장률이 2%에서 4%로 상승하고 요구수익률이 8%일 때 주식가치 변화를 계산해줘.",
    "주당 배당금 3,000원, 배당성장률이 4%에서 2%로 하락하고 요구수익률이 10%일 때 주식가치 변화를 계산해줘.",
]
...
def log_successful_question(question: str):
    ...
    cleaned = normalize_company_pair_particles(question.strip().rstrip("."))
...
def _question_family(question: str) -> str:
    compact = question.replace(" ", "").lower()
    if (
        ("매출원가율" in compact and "시나리오" in compact)
        or ("배당성장률" in compact and "요구수익률" in compact)
...
def _is_recommendation_question_eligible(question: str) -> bool:
    ...
    if any(token in question for token in ["반도체 가격", "반도체가격", "메모리 가격", "메모리가격"]):
        return False
