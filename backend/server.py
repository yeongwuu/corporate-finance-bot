...
ADVANCED_QUESTION_SEEDS = [
    ...
    "원/달러 환율이 10% 하락하고 기준금리가 1%p 상승하며 반도체 가격이 15% 하락하면 삼성전자의 영업이익과 적정 주가가 얼마나 변할지 분석해줘.",
...
VALUATION_STRESS_QUESTION_SEEDS = [
    ...
    "현대차의 매출 성장률이 4%p, 영업이익률이 2%p 동시에 하락하는 스트레스 시나리오를 분석해줘.",
    "기아의 매출 성장률이 4%p, 영업이익률이 2%p 동시에 하락하는 스트레스 시나리오를 분석해줘.",
    "삼성전자의 매출 성장률이 5%p, 영업이익률이 2%p 동시에 하락하는 스트레스 시나리오를 분석해줘.",
    "삼성전기의 매출 성장률이 4%p, 영업이익률이 2%p 동시에 하락하는 스트레스 시나리오를 분석해줘.",
    ...
    "기준금리가 1%p 상승하고 원/달러 환율이 10% 오르면 삼성전자의 영업이익과 적정가치는 어떻게 변할까?",
    "기준금리가 1%p 상승하고 원/달러 환율이 10% 오르면 LG에너지솔루션의 영업이익과 적정가치는 어떻게 변할까?",
    "기준금리가 0.5%p 상승하고 원/달러 환율이 8% 오르면 SK하이닉스의 영업이익과 적정가치는 어떻게 변할까?",
    "원/달러 환율이 10% 하락하고 기준금리가 1%p 상승하며 반도체 가격이 15% 하락하면 삼성전자의 영업이익과 적정 주가가 얼마나 변할지 분석해줘.",
    "원/달러 환율이 10% 하락하고 기준금리가 1%p 상승하며 반도체 가격이 15% 하락하면 SK하이닉스의 영업이익과 적정 주가가 얼마나 변할지 분석해줘.",
    "원/달러 환율이 8% 하락하고 기준금리가 0.5%p 상승하며 반도체 가격이 10% 하락하면 삼성전자의 영업이익과 적정 주가가 얼마나 변할지 분석해줘.",
    "원/달러 환율이 8% 하락하고 기준금리가 0.5%p 상승하며 반도체 가격이 10% 하락하면 SK하이닉스의 영업이익과 적정 주가가 얼마나 변할지 분석해줘.",
    "LG에너지솔루션의 매출 성장률이 3%p, 영업이익률이 1%p 동시에 하락하는 스트레스 시나리오를 분석해줘.",
    "기준금리가 0.5%p 상승하고 원/달러 환율이 8% 오르면 현대차의 영업이익과 적정가치는 어떻게 변할까?",
    "기준금리가 0.5%p 상승하고 원/달러 환율이 8% 오르면 기아의 영업이익과 적정가치는 어떻게 변할까?",
]
