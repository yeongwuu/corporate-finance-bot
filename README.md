...
- 추천 질문 풀은 재무 DB의 기업·산업군을 조합한 고유 질문 200개로 구성됩니다.
...
| `LLM_BASE_URL` | 선택적 LLM API 주소 |
| `DART_API_KEY` | DART 재무제표·공시 조회 |
| `NAVER_CLIENT_ID` | Naver News API |
| `NAVER_CLIENT_SECRET` | Naver News API |
| `BACKEND_CORS_ORIGIN_REGEX` | 허용 프론트엔드 도메인 |
| `VITE_API_URL` | 프론트엔드 API 주소 |
| `VITE_API_HOSTNAME` | Render API 호스트명 |
