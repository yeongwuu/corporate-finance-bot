...
2019~2025년 한국거래소(KRX)의 코스피·코스닥 상장기업 및 데이터에 포함된 기타법인의 Excel 재무 데이터를 사용하며 재무상태표, 손익계산서와 현금흐름표를 포함합니다. Excel 데이터를 정규화해 SQLite 데이터베이스에 적재하고 기업·연도·계정별 재무정보를 조회합니다.
